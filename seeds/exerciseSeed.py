...
exercises_to_insert = [
    ...
    ("PULL OVER (MANCUERNA)", "PECTORALES", "img/PECTORALES/15.webp"),
    ...
    # GLÚTEOS (7 items)
    ("GLÚTEOS MÁQUINA (4 APOYOS)", "GLÚTEOS", "img/GLÚTEOS/1.jpg"),
    ("GLÚTEOS POLEA PATADAS", "GLÚTEOS", "img/GLÚTEOS/2.jpg"),
    ("GLÚTEOS PUENTES (EN BANCO)", "GLÚTEOS", "img/GLÚTEOS/3.avif"),
    ("SUBIDAS A STEPS EN DESPLANTE", "GLÚTEOS", "img/GLÚTEOS/4.jpg"),
    ...
    ("POLEA A UNA MANO (HACIA ABAJO)", "TRICEPS", "img/TRICEPS/7.jpg"),
    ("POLEA A UNA MANO (HORIZONTAL)", "TRICEPS", "img/TRICEPS/8.jpg"),
    ...
    ("BANCO SCOTT (CON BARRA)", "BÍCEPS", "img/BÍCEPS/6.webp"),
    ...
    # HOMBROS (1 - 12)
    ("PRESS CON MANCUERNA SENTADO", "HOMBROS", "img/HOMBROS/1.png"),
    ("PRESS MILITAR", "HOMBROS", "img/HOMBROS/2.png"),
    ("PRESS EN MÁQUINA", "HOMBROS", "img/HOMBROS/3.png"),
    ("PRESS CON BARRA", "HOMBROS", "img/HOMBROS/4.png"),
    ("REMO AL MENTÓN CON BARRA", "HOMBROS", "img/HOMBROS/5.png"),
    ("VUELOS LATERALES DE PIE", "HOMBROS", "img/HOMBROS/6.png"),
    ("VUELO LATERAL EN POLEA A UNA MANO", "HOMBROS", "img/HOMBROS/7.png"),
    ("VUELOS LATERALES SENTADO", "HOMBROS", "img/HOMBROS/8.png"),
    ("VUELO LATERAL EN BANCO INCLINADO", "HOMBROS", "img/HOMBROS/9.png"),
    ("VUELOS POSTERIORES EN MÁQUINA", "HOMBROS", "img/HOMBROS/10.png"),
    ("VUELOS POSTERIORES SENTADO CON MANCUERNA", "HOMBROS", "img/HOMBROS/11.png"),
    ("VUELOS FRONTALES", "HOMBROS", "img/HOMBROS/12.png"),

    # ANTEBRAZO (Selección sugerida: 1 - 3)
    ("CURL DE ANTEBRAZO CON BARRA (PALMAS ARRIBA)", "ANTEBRAZO", "img/ANTEBRAZO/1.png"),
    ("CURL DE ANTEBRAZO CON BARRA (PALMAS ABAJO)", "ANTEBRAZO", "img/ANTEBRAZO/2.png"),
    ("PASEO DEL GRANJERO (FARMER WALK)", "ANTEBRAZO", "img/ANTEBRAZO/3.png"),
]
...
class SeedExercise:
    ...
    def run(self):
        ...
        try:
            if(cant == 0):
                for name, type, img in exercises_to_insert:
