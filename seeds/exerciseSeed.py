...
exercises_to_insert = [
    ...
    ("REMO CON BARRA (PRONO)", "ESPALDA", "img/ESPALDA/5.png"),
    ...
    ("MARTILLO", "BÍCEPS", "img/BÍCEPS/3.jpg"),
    ...
    # HOMBROS (1 - 12)
    ("PRESS CON MANCUERNA SENTADO", "HOMBROS", "img/HOMBROS/1.jpg"),
    ("PRESS MILITAR", "HOMBROS", "img/HOMBROS/2.jpg"),
    ("PRESS EN MÁQUINA", "HOMBROS", "img/HOMBROS/3.jpg"),
    ("REMO AL MENTÓN CON BARRA", "HOMBROS", "img/HOMBROS/5.jpg"),
    ("VUELOS LATERALES DE PIE", "HOMBROS", "img/HOMBROS/6.jpg"),
    ("VUELO LATERAL EN POLEA A UNA MANO", "HOMBROS", "img/HOMBROS/7.jpg"),
    ("VUELOS LATERALES SENTADO", "HOMBROS", "img/HOMBROS/8.webp"),
    ("VUELO LATERAL EN BANCO INCLINADO", "HOMBROS", "img/HOMBROS/9.jpg"),
    ("VUELOS POSTERIORES EN MÁQUINA", "HOMBROS", "img/HOMBROS/10.jpg"),
    ("VUELOS POSTERIORES SENTADO CON MANCUERNA", "HOMBROS", "img/HOMBROS/11.jpg"),
    ("VUELOS FRONTALES", "HOMBROS", "img/HOMBROS/12.jpg"),

    # ANTEBRAZO (Selección sugerida: 1 - 3)
    ("CURL DE ANTEBRAZO CON BARRA (PALMAS ARRIBA)", "ANTEBRAZO", "img/ANTEBRAZO/1.jpg"),
    ("CURL DE ANTEBRAZO CON BARRA (PALMAS ABAJO)", "ANTEBRAZO", "img/ANTEBRAZO/2.jpg"),
]
